...
<form method="POST" >
	...
	<h2>Requirements</h2>
	<ul>
		<li>Your full Name is required, and the full name must be no longer than 30 characters in length.</li>
		<li>Your age is required, and the age must be greater than 0.</li>
		<li>Your student type is required, a valid student type must be chosen. </li>
	</ul>

	<fieldset>
	<legend>Survey (1/3)</legend>
	...
	<table>
		<tr><td><input type="submit" class="btn" disabled="disabled" name="sv_b_back1" value="Previous"></td>
		    <td><input type="submit" class="btn" name="sv_b_next1" value="Next"></td>
		</tr>
	</table>
<?php
}
